...
namespace PhoneSpamerRobot.Sites
{
    class DetMir : ISite
    {
        public void SpamSite()
        {
            ...
            try
            {
                IWebElement btn1 = ISite.browser.FindElement(By.XPath("//*[@id=\"app-container\"]/div[2]/header/div[3]/div/div/div/div/span/div"));
                btn1.Click();
                Thread.Sleep(1000);

                IWebElement btn = ISite.browser.FindElement(By.XPath("//*[@id=\"iB\"]/div[2]/div/div/div[2]/div/div/button[3]/div/div/div"));
                btn.Click();
                Thread.Sleep(1000);
                ...
                IWebElement btn2 = ISite.browser.FindElement(By.XPath("//*[@id=\"iB\"]/div[3]/div/div/div[2]/div/div/button/div/div"));
                btn2.Click();

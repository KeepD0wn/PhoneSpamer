    ...
    class NewTel : ISite
    {
        public void SpamSite()
        {
            ...
            try
            {
                ...
                ISite.browser.FindElement(By.XPath("/html/body/div[30]/form/div[4]/input")).SendKeys(ISite.mail);
                ISite.browser.FindElement(By.XPath("/html/body/div[30]/form/div[4]/input")).SendKeys(ISite.PhoneNumberWithout7);
                Thread.Sleep(1000);

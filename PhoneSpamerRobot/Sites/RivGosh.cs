...
namespace PhoneSpamerRobot.Sites
{
    class RivGosh : ISite
    {
        ...
        {
            ISite.browser.Navigate().GoToUrl("https://rivegauche.ru/");
            ISite.browser.Manage().Window.Maximize();

            try
            {
                IWebElement btn = ISite.browser.FindElement(By.XPath("/html/body/app-root/layout/header/div[2]/div[2]"));
                btn.Click();
                Thread.Sleep(1000);

                IWebElement btn1 = ISite.browser.FindElement(By.XPath("/html/body/overlay/div/auth-wnd/div/button/span"));
                btn1.Click();
                Thread.Sleep(1000);

                IWebElement btn2 = ISite.browser.FindElement(By.XPath("/html/body/overlay/div/registration/form/confirm-contact/tab-group/div[1]/div[2]"));
                btn2.Click();
                Thread.Sleep(1000);


                ISite.browser.FindElement(By.XPath("/html/body/overlay/div/registration/form/confirm-contact/tab-group/div[2]/tab[2]/error-control/div/phone-input/masked-input-ctrl/input")).SendKeys(ISite.PhoneNumberWithout7);
